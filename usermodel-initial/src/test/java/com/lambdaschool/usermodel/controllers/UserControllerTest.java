...
public class UserControllerTest {
    ...
    public void bb_getUserByIdNotFound() throws Exception {
        String apiURL = "/users/user/2000";
        Mockito.when(userService.findUserById(2000)).thenReturn(null);
    ...
    @Test
    public void cc_getUserLikeName() throws Exception {
    ...
    @Test
    public void d_addNewUser() throws Exception {
        String apiURL = "/users/user";

        User u6 = new User("ChocoTest",
                "123321123",
                "ChocTest@school.lambda");
        u6.setUserid(60);
    ...
    @Test
    public void e_deleteUserById() throws Exception {
        String apiURL = "/users/user/20";
